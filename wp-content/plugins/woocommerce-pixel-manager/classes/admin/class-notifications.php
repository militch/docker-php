...
class Notifications {
	...
	public function __construct() {
		...
		if (Environment::get_instance()->is_allowed_notification_page()) {
			if (true) {
...
//		}
	...
	public static function plugin_is_incompatible( $name, $version, $slug, $link = '', $wpm_doc_link = '' ) {
		...
		<div class="notice notice-error <?php echo esc_js($slug); ?>-incompatible-plugin-error">
			<p>
				<span>
					<?php esc_html_e('The following plugin is not compatible with the Pixel Manager Pro for WooCommerce: ', 'woocommerce-google-adwords-conversion-tracking-tag'); ?>
				</span>
				<span>
	...
	public static function dismiss_expired_license_warning__premium_only() {
		...
		update_option(WPM_DB_NOTIFICATIONS_NAME, $saved_notifications);
			...
			<div id="active-opportunities-notification"
				...
				<div style="text-align: right;display: flex;flex-direction: column;">
					<div id="pmw-dismiss-opportunities-message-button"
						 class="button pmw-notification-dismiss-button"
						 style="white-space:normal;margin-bottom: 6px;text-align: center;"><?php esc_html_e('Click here to dismiss this notification', 'woocommerce-google-adwords-conversion-tracking-tag'); ?>
					</div>
