...
//		);
	...
	public static function get_product_details_for_datalayer( $product ) {
		...
		if (Environment::get_instance()->is_wpml_woocommerce_multi_currency_active()) {
	...
	public static function get_brand_name( $product_id ) {
		...
		if (Environment::get_instance()->is_yith_wc_brands_active()) {
			$brand_taxonomy = 'yith_product_brand';
		} elseif (Environment::get_instance()->is_woocommerce_brands_active()) {
